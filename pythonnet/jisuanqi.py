...
btn2_2 = tkinter.Button(text='CE', bg='#988', bd=3,
                        command=lambda: gui0())  # CE是清除全部数字，但不影响以前的计算
btn2_2.place(x=70, y=130, width=50, height=50)
btn2_3 = tkinter.Button(text='C', bg='#988', bd=3,
                        command=lambda: gui0())  # C健是重新开始计算，和ESC键是一样的功能
btn2_3.place(x=130, y=130, width=50, height=50)
btn2_4 = tkinter.Button(text='+/-', bg='#988', bd=3,
                        command=lambda: pressnum('+/-'))
btn2_4.place(x=190, y=130, width=50, height=50)
btn2_5 = tkinter.Button(text='√', bg='#988', bd=3,
                        command=lambda: equal('√'))  # --------√开平方
btn2_5.place(x=250, y=130, width=50, height=50)
# 第三行
btn3_1 = tkinter.Button(text='7', bg='#aaaaaa', bd=3,
                        command=lambda: pressnum('7'))
btn3_1.place(x=10, y=190, width=50, height=50,)
btn3_2 = tkinter.Button(text='8', bg='#aaaaaa', bd=3,
                        command=lambda: pressnum('8'))
btn3_2.place(x=70, y=190, width=50, height=50)
btn3_3 = tkinter.Button(text='9', bg='#aaaaaa', bd=3,
...
# ----------------------------------倒数
btn4_5 = tkinter.Button(text='1/x', bg='#708069', command=lambda: equal('1/x'))
btn4_5.place(x=250, y=250, width=50, height=50)
# 第五行
btn5_1 = tkinter.Button(text='1', bg='#aaaaaa', bd=3,
                        command=lambda: pressnum('1'))
btn5_1.place(x=10, y=310, width=50, height=50)
btn5_2 = tkinter.Button(text='2', bg='#aaaaaa', bd=3,
                        command=lambda: pressnum('2'))
btn5_2.place(x=70, y=310, width=50, height=50)
btn5_3 = tkinter.Button(text='3', bg='#aaaaaa', bd=3,
...
# 第六行
btn6_1 = tkinter.Button(text='0', bg='#aaaaaa', bd=3,
                        command=lambda: pressnum('7'))
